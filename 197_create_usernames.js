...
//p We are given an array of objects . will objects ever be empty? Will all keys be the same in each object? Will any values be null?

//R: We are returning the array of objects with the username property added to each object
